  ...
  return (
    <div className="min-h-screen bg-[#FFFCF7] flex items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        {[
          { l: "12%", d: "0s", dur: "7s", e: "🌶️" },
          { l: "28%", d: "1.4s", dur: "8.5s", e: "✨" },
          { l: "58%", d: "0.6s", dur: "7.5s", e: "🧄" },
          { l: "76%", d: "2.2s", dur: "9s", e: "✨" },
          { l: "90%", d: "1s", dur: "8s", e: "🌿" },
        ].map((p, i) => (
          <span
            key={i}
      ...
      <div className="w-full max-w-md relative z-10">
        {/* Brand */}
        <div className="text-center mb-8 fade-up" style={{ animationDelay: "0.05s" }}>
          ...
          <h1 className="text-4xl font-extrabold text-[#241608]" style={{ fontFamily: "'Baloo 2', sans-serif" }}>
            Foodie
          </h1>
